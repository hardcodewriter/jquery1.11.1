$(function() {
	...
	a.click(function() {
		var t = $(this);
		t.hasClass("active") ? (t.find(".sub-menu").slideUp(), t.removeClass("active")) : (e.slideUp(), a.removeClass("active"), t.find(".sub-menu").slideDown(), t.addClass("active"))
	}), e.find("a").click(function() {
		{
			var a = $(this);
			a.data("target")
		}
		e.find("li").removeClass("active"), a.parent().addClass("active")
	...
	$('li a[href="' + t.substring(t.lastIndexOf("/") + 1) + '"]').parent().addClass("active").parent().slideDown().parent().addClass("active"), $("#main-wraper").css("min-height", $(window).height() - 46), $("#footer-con").fadeIn();
	var l = [{
		value: "all",
		data: "all"
	}, {
	...
	document.getElementById('footer-con').style.display = "none";
	$(".top-nav").find("a.source").hide();
	$(".donate-con").hide();
});