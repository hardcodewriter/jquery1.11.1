$(function() {
	function a() {
		this.$element = $("#col-list"), this.options = d, this.colHeightArray = [], this.styleQueue = [], this._init()
	}
	var e = $("#tips-con"),
		t = e.length >= 1 ? e.data("key") : "tips";
	$show_tips = window.localStorage ? window.localStorage.getItem(t) : null, !$show_tips && e.length >= 1 && (e.show(), e.find("#tips-close").click(function() {
		e.slideUp(), window.localStorage.setItem(t, "true")
	...
	a.prototype = {
		...
		_getColumns: function() {
			var a = this.options,
				e = a.fitWidth ? this.$element.parent() : this.$element,
				t = "BODY" === e[0].tagName ? e.width() - 20 : e.width(),
				l = a.colWidth,
				d = a.gutterWidth,
				u = a.minCol,
				r = a.maxCol,
		...
		_getItems: function(a) {
			var e = a.filter("." + this.options.itemCls).css({
				position: "absolute"
			});
			return e
		},
		...
		layout: function(a, e) {
			var t, l, d, u, r, i, s = this.options,
				v = this._getItems(a),
				n = "css",
				o = s.animationOptions,
				c = s.colWidth,
				p = s.gutterWidth,
				h = this.colHeightArray.length,
				y = s.align;
			for (this.$element.append(v), "center" === y ? (t = (this.$element.width() - c * h - p * (h - 1)) / 2, t = t > 0 ? t : 0) : "left" === y ? t = 0 : "right" === y && (t = this.$element.width() - c * h - p * (h - 1)), d = 0, r = v.length; r > d; d++) this._placeItems(v[d], t);
			for (u = 0, i = this.styleQueue.length; i > u; u++) l = this.styleQueue[u], l.$el[n](l.style, o);
			this.$element.height(Math.max.apply({}, this.colHeightArray)), this.styleQueue = [], e && e.call(v), $("#main-loading").delay(500).fadeOut("normal", function() {
		...
		_placeItems: function(a, e) {
			var t, l, d = $(a),
				...
				i = u.gutterWidth,
				s = u.gutterHeight,
				v = this.colHeightArray,
				n = (v.length, Math.min.apply({}, v)),
				o = $.inArray(n, v);
			t = o, l = {
				left: (r + i) * t + e,
				top: v[t]
	...
	}, new a, $("#left-panel").mCustomScrollbar({
		theme: "rounded"
	});
	var u = $("#main-menu > li"),
		r = $(".sub-menu");
	u.click(function() {
		var a = $(this);
		a.hasClass("active") ? (a.find(".sub-menu").slideUp(), a.removeClass("active")) : (r.slideUp(), u.removeClass("active"), a.find(".sub-menu").slideDown(), a.addClass("active"))
	}), r.find("a").click(function() {
		{
			var a = $(this);
			a.data("target")
		}
		r.find("li").removeClass("active"), a.parent().addClass("active")
